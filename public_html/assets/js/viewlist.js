$(document).ready(() => {
  ...
  $("#deleteList").click(() => {
    const swalWithBootstrapButtons = Swal.mixin({
      customClass: {
        confirmButton: 'px-5 py-1.5 bg-emerald-500 rounded-md mx-2 text-white',
        cancelButton: 'px-5 py-1.5 bg-red-500 rounded-md mx-2 text-white'
      },
      ...
      if (result.isConfirmed) {
          $.ajax({
            ...
            if (data.success) {
              ...
              Swal.fire({
                title: 'Deleted!',
                html: 'List Deleted. Reloading in <b></b> milliseconds.',
                timer: 3000,
